  ...
  return (
    ...
    >
      {Children.map(children, (child) =>
        cloneElement(child as React.ReactElement<ChildComponentProps>, { isHovered })
      )}
    </motion.div>
  );
}
  ...
  return (
    ...
    >
      <motion.div
        ...
        className={`${className} fixed left-4 top-1/2 -translate-y-1/2 flex flex-col items-center w-fit gap-4 rounded-2xl border-neutral-700 border-2 py-4 px-2 bg-black`}
